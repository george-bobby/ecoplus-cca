  ...
  return (
    <div ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div
        ...
        style={{
          backgroundImage: 'url("https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fA%3D%3D&auto=format&fit=crop&w=2070&q=80")',
        }}
      >
      ...
      <div className="relative text-center text-white px-4 max-w-4xl mx-auto">
        ...
        <p className="hero-subtitle text-xl mb-12 ">
          Explore real-time climate data, track temperature changes,<br /> carbon emissions, and more.
        </p>
